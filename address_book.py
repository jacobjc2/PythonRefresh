# Make it look like: https://code-projects.org/address-book-in-python-with-source-code/
...
Label(root, text = 'NAME', font='arial 12 bold', bg = 'gray90').place(x= 30, y=20)
Entry(root, textvariable = Name).place(x= 100, y=20)

Label(root, text = 'PHONE NO.', font='arial 12 bold',bg = 'gray90').place(x= 30, y=70)
